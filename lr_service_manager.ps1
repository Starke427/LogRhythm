...
$serviceList="LogRhythmAdminAPI","LRAIEEngine","LogRhythmAIEngineCacheDrilldown","LRAIEComMgr","scarm","LogRhythmAPIGateway","LogRhythmAuthenticationAPI","lrjobmgr","LogRhythmMetricsCollection","LogRhythmMetricsDatabase","LogRhythmMetricsWebUI","LogRhythmNotificationService","LogRhythmServiceRegistry","LogRhythmSQLService","LogRhythmWindowsAuthenticationService","SQLSERVERAGENT"
